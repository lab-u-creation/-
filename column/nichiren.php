...
appConfigPage::$title = appConfigColumnother::column['nichiren']['name'];
?>
...
<div class="container">
  <div class="font-size-1_4 font-size-lg-2_4 line-height-1 border-contrast-left pl-3 color-dgray font-weight-bold">
    <?php echo appConfigColumnother::column['nichiren']['name']; ?><br>
    <span class="font-size-1 font-size-lg-1_2"><?php echo appConfigColumnother::column['nichiren']['sub']; ?></span>
  </div>
</div>
</header>
                ...
                <div class="pb-2 mb-5">
                  <table border="1" class="col-12 text-center">
                    <tr class="color-dgray bg-lgray">
                      <th class="col-3 col-lg-3 font-size-1_2 p-2"></th>
                      <th class="col-3 col-lg-3 font-size-1_2 p-2">勤行数珠</th>
                      <th class="col-3 col-lg-3 font-size-1_2 p-2">装束数珠</th>
                    </tr>
                    <tr>
                      <th class="col-3 col-lg-3 font-size-1_2 font-size-lg-1_2 color-dgray bg-lgray p-2">用途</th>
                      <td class="p-2">檀家・信徒・一般向け</td>
                      <td class="p-2">僧侶向け</td>
                    </tr>
                    <tr>
                      <th class="col-3 col-lg-3 font-size-1_2 font-size-lg-1_2 color-dgray bg-lgray p-2">素材</th>
                      <td class="p-2">華美でないもの<br>（自然木・木の実など）</td>
                      <td class="p-2">高価なもの<br>（白水晶・真珠など）</td>
                    </tr>
                    <tr>
                      <th class="col-3 col-lg-3 font-size-1_2 font-size-lg-1_2 color-dgray bg-lgray p-2">房</th>
                      <td class="p-2">丸い（菊房・玉房）</td>
                      <td class="p-2">切り房<br>（希望の長さで切ったもの）</td>
                    </tr>
                    <tr>
                      <th class="col-3 col-lg-3 font-size-1_2 font-size-lg-1_2 color-dgray bg-lgray p-2">房の長さ</th>
                      <td class="p-2">短房（普通の長さ）</td>
                      <td class="p-2">中房（少し長い）<br>長房（長い）</td>
                    </tr>
                  </table>
                </div>
              ...
              <div class="pb-3">
                ...
                <div class="pt-2 pb-4">
                  ...
                  <div class="pb-2 mb-2">
                    <table border="1" class="col-12 text-center">
                      <tr class="color-dgray bg-lgray">
                        <th class="col-3 col-lg-3 font-size-1_2 p-2">法要</th>
                        <th class="col-3 col-lg-3 font-size-1_2 p-2">時期</th>
                      </tr>
                      <tr>
                        <td class="p-2">一周忌</td>
                        <td class="p-2">満1年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">三回忌</td>
                        <td class="p-2">満2年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">七回忌</td>
                        <td class="p-2">満6年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">十三回忌</td>
                        <td class="p-2">満12年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">十七回忌</td>
                        <td class="p-2">満16年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">二十三回忌 ※</td>
                        <td class="p-2">満22年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">二十七回忌 ※</td>
                        <td class="p-2">満26年目</td>
                      </tr>
                      <tr>
                        <td class="p-2">三十三回忌</td>
                        <td class="p-2">満32年目</td>
                      </tr>
                    </table>
                  </div>
                  <p class="font-size-lg-1_1 line-height-1_7">
              ...
              <div class="pb-3">
                  ...
                  <p class="font-size-lg-1_1 line-height-1_7">
                    ...
                    <div class="pb-2 mb-2">
                      <table border="1" class="col-12">
                        <tr class="color-dgray bg-lgray">
                          <th class="col-3 col-lg-3 font-size-1_2 text-center p-2">必要なもの</th>
                          <th class="col-8 col-lg-8 font-size-1_2 text-center p-2">手配方法</th>
                        </tr>
                        <tr>
                          <td class="text-center p-2">本位碑</td>
                          <td class="p-2">四十九日法要で白木位牌から交換した位牌</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">遺影</td>
                          <td class="p-2">葬儀で使用した写真</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">本堂供花</td>
                          <td class="p-2">葬儀社・生花店などに手配</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">本堂供え物</td>
                          <td class="p-2">葬儀社・生花店などに手配</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">墓用供花</td>
                          <td class="p-2">葬儀社・生花店などに手配</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">墓用線香</td>
                          <td class="p-2">葬儀社・寺院などに手配</td>
                        </tr>
                      </table>
                    </div>
                ...
                <div class="pt-2 pb-4">
                  ...
                  <div class="pb-2 mb-2">
                    <table border="1" class="col-12">
                      <tr class="color-dgray bg-lgray">
                        <th class="col-5 col-lg-5 font-size-1_2 text-center p-2">法要の種類</th>
                        <th class="col-3 col-lg-3 font-size-1_2 text-center p-2">お布施の目安</th>
                      </tr>
                      <tr>
                        <td class="p-2">四十九日法要・一周忌（納骨法要を含まない）</td>
                        <td class="text-center p-2">3万円～5万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">四十九日法要・一周忌（納骨法要を含む）</td>
                        <td class="text-center p-2">3万円～10万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">三回忌～</td>
                        <td class="text-center p-2">1万円～5万円</td>
                      </tr>
                    </table>
                  </div>
                  <p class="font-size-lg-1_1 line-height-1_7">
              ...
              <p class="font-size-lg-1_1 line-height-1_7">
                    ...
                    <div class="pb-2 mb-2">
                      <table border="1" class="col-12">
                        <tr class="color-dgray bg-lgray text-center">
                          <th class="col-3 col-lg-3 font-size-1_2 p-2">項目</th>
                          <th class="col-8 col-lg-8 font-size-1_2 p-2">マナー</th>
                        </tr>
                        <tr>
                          <td class="text-center p-2">不祝儀袋</td>
                          <td class="p-2">蓮の花が印刷されたもの、または白無地</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">水引</td>
                          <td class="p-2">「黒白」または「双銀」の結びきり</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">表書き</td>
                          <td class="p-2">[水引上段]<br>四十九日法要まで：「<span class="color-pink font-weight-bold">御霊前</span>」または「御香典」<br>四十九日法要以降：「<span class="color-plan5 font-weight-bold">御仏前</span>」または「御香典」<br>
                            <br>
                            [水引下段]<br>中央に名前（フルネーム）を記載</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">中袋</td>
                          <td class="p-2">葬儀社・生花店などに手配</td>
                        </tr>
                        <tr>
                          <td class="text-center p-2">筆記方法</td>
                          <td class="p-2">葬儀社・生花店などに手配</td>
                        </tr>
                      </table>
                    </div>
                ...
                <div class="pt-2 pb-4">
                  ...
                  <div class="pb-2 mb-5">
                    <table border="1" class="col-12 text-center">
                      <tr class="color-dgray bg-lgray">
                        <th class="col-3 col-lg-3 font-size-1_2 p-2">故人との関係</th>
                        <th class="col-4 col-lg-4 font-size-1_2 p-2">香典（参列）</th>
                        <th class="col-4 col-lg-4 font-size-1_2 p-2">香典（一周忌）</th>
                      </tr>
                      <tr>
                        <td class="p-2">両親</td>
                        <td class="p-2">5万円～10万円</td>
                        <td class="p-2">1万円～5万円 ※</td>
                      </tr>
                      <tr>
                        <td class="p-2">祖父母</td>
                        <td class="p-2">1万円～3万円</td>
                        <td class="p-2">1万円～3万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">兄弟姉妹</td>
                        <td class="p-2">3万円～5万円</td>
                        <td class="p-2">1万円～3万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">親戚のおじ、おば</td>
                        <td class="p-2">1万円～2万円</td>
                        <td class="p-2">1万円～3万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">遠い親戚</td>
                        <td class="p-2">5千～1万円</td>
                        <td class="p-2">1万円～3万円</td>
                      </tr>
                      <tr>
                        <td class="p-2">元上司</td>
                      ...
                      <div class="position-absolute d-inline-block bg-orange rounded-pill color-white p-1 pl-3 pr-3 font-size-1" style="top:-17px;">関連記事</div>
                        <div class="row no-gutters pt-2">
                          ...
                          <div class="col-8 col-lg-9 pr-sm-3">
                            <div class="font-size-1_2 font-size-lg-1_4 line-height-1 font-weight-bold pb-2">香典の書き方 <span class="font-size-1">～基本マナーと注意点を徹底解説～</span></div>
